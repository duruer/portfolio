export default {
  bio: {
    ...
    social_links: [
      {
        name: "GitLab",
        url: "https://gitlab.com/kahverengi",
        svg_code:
      ...
      {
        name: "Facebook",
        url: "https://www.facebook.com/Ahmet.Enes.Duruer",
        svg_code:
          '<svg\n\t\t\t\t\t\txmlns="http://www.w3.org/2000/svg"\n\t\t\t\t\t\twidth="20"\n\t\t\t\t\t\theight="20"\n\t\t\t\t\t\tviewBox="0 0 24 24"\n\t\t\t\t\t\tfill="none"\n\t\t\t\t\t\tstroke="currentColor"\n\t\t\t\t\t\tstroke-width="2"\n\t\t\t\t\t\tstroke-linecap="round"\n\t\t\t\t\t\tstroke-linejoin="round"\n\t\t\t\t\t\tclass="feather feather-facebook"\n\t\t\t\t\t>\n\t\t\t\t\t\t<path\n\t\t\t\t\t\t\td="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1\n              1-1h3z"\n\t\t\t\t\t\t/>\n\t\t\t\t\t</svg>',
      },
      {
        name: "LinkedIn",
        url: "https://linkedin.com/in/ahmet-enes-duruer-9bb3b554",
        svg_code:
  ...
  pages: {
    about: {
      interests: [
        {
          language_name: "javascript_developing",
          svg_code:
        ...
        {
          language_name: "back_end_developing",
          svg_code:
            '<svg\n            xmlns="http://www.w3.org/2000/svg"\n            width="24"\n            height="24"\n            viewBox="0 0 24 24"\n            fill="none"\n            stroke="currentColor"\n            stroke-width="2"\n            stroke-linecap="round"\n            stroke-linejoin="round"\n            class="feather feather-coffee">\n            <path d="M18 8h1a4 4 0 0 1 0 8h-1"></path>\n            <path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path>\n            <line x1="6" y1="1" x2="6" y2="4"></line>\n            <line x1="10" y1="1" x2="10" y2="4"></line>\n            <line x1="14" y1="1" x2="14" y2="4"></line>\n          </svg>',
        },
        {
          language_name: "server",
          svg_code:
